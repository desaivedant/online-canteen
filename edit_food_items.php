...
<div class="col-xs-3">
  <div class="form-area" style="padding: 10px 10px 110px 10px; "> 
    ...
    $query = mysqli_query($conn, "UPDATE food_mst set
    name='$name', price='$price', category='$category' ,
    description='$description' where F_ID='$F_ID'");
    }
    $query = mysqli_query($conn, "SELECT * FROM food_mst ORDER BY F_ID");
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM food_mst WHERE F_ID=$update");
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
		  ...
		  <div class="form-group">
            ...
            <input type="text" class="form-control" id="dcategory" name="dcategory" value=<?php echo $row1['food_category'];  ?> placeholder="Your Category ID" required="">
          </div>
