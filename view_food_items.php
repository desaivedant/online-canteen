...
<html>
  ...
  <body>
w  <button onclick="topFunction()" id="myBtn" title="Go to top">
...
$sql = "SELECT * FROM food_mst,catg_mst WHERE food_mst.food_category = catg_mst.category_id AND food_mst.options = 'ENABLE' ";
