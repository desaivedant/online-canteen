<html>
<head>
    <title> Guest Signup |Stop My Starvation</title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h3>Hi Guest, <br> Welcome to <span class="edit">Stop My Starvation</span></h3>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
		...
		<div class="row">
          <div class="form-group col-xs-12">
            <label for="address"><span class="text-danger" style="margin-right: 5px;">*</span> City: </label>
            <div class="input-group">
		...
		<div class="row">
          <div class="form-group col-xs-12">
            <label for="address"><span class="text-danger" style="margin-right: 5px;">*</span> State: </label>
            <div class="input-group">
		...
		<div class="row">
          <div class="form-group col-xs-12">
            <label for="address"><span class="text-danger" style="margin-right: 5px;">*</span> Pin Code: </label>
            <div class="input-group">
              <input class="form-control" id="pin type="text" name="pin" placeholder="Pin Code" required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
            </span>
              </span>
